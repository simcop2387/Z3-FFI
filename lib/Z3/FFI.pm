...
my $functions = [
  ...
  #[fixedpoint_query_relations => ["Z3_context", "Z3_fixedpoint", "uint", "Z3_func_decl[]"] => "Z3_lbool"],
  ...
  #[fixedpoint_set_predicate_representation => ["Z3_context", "Z3_fixedpoint", "Z3_func_decl", "uint", "Z3_symbol[]"] => "void"],
  ...
  #[fixedpoint_to_string => ["Z3_context", "Z3_fixedpoint", "uint", "Z3_ast[]"] => "Z3_string"],
  ...
  #[qe_model_project => ["Z3_context", "Z3_model", "uint", "Z3_app[]", "Z3_ast"] => "Z3_ast"],
  #[qe_model_project_skolem => ["Z3_context", "Z3_model", "uint", "Z3_app[]", "Z3_ast", "Z3_ast_map"] => "Z3_ast"],
  ...
  [mk_array_sort_n => ["Z3_context", "uint", "Z3_sort const *", "Z3_sort"] => "Z3_sort"],
  [mk_tuple_sort => ["Z3_context", "Z3_symbol", "uint", "Z3_symbol[]", "Z3_sort[]", "Z3_func_decl *", "Z3_func_decl[]"] => "Z3_sort"],
  [mk_enumeration_sort => ["Z3_context", "Z3_symbol", "uint", "Z3_symbol[]", "Z3_func_decl[]", "Z3_func_decl[]"] => "Z3_sort"],
  [mk_list_sort => ["Z3_context", "Z3_symbol", "Z3_sort", "Z3_func_decl*", "Z3_func_decl*", "Z3_func_decl*", "Z3_func_decl*", "Z3_func_decl*", "Z3_func_decl* tail_decl "] => "Z3_sort"],
  [mk_constructor => ["Z3_context", "Z3_symbol", "Z3_symbol", "uint", "Z3_symbol[]", "Z3_sort_opt[]", "uint sort_refs[] "] => "Z3_constructor"],
  [del_constructor => ["Z3_context", "Z3_constructor"] => "void"],
  [mk_datatype => ["Z3_context", "Z3_symbol", "uint", "Z3_constructor[]"] => "Z3_sort"],
  [mk_constructor_list => ["Z3_context", "uint", "Z3_constructor[]"] => "Z3_constructor_list"],
  [del_constructor_list => ["Z3_context", "Z3_constructor_list"] => "void"],
  [mk_datatypes => ["Z3_context", "uint", "Z3_symbol[]", "Z3_sort[]", "Z3_constructor_list[]"] => "void"],
  [query_constructor => ["Z3_context", "Z3_constructor", "uint", "Z3_func_decl*", "Z3_func_decl*", "Z3_func_decl[]"] => "void"],
  [mk_func_decl => ["Z3_context", "Z3_symbol", "uint", "Z3_sort[]", "Z3_sort"] => "Z3_func_decl"],
  [mk_app => [" Z3_context", "Z3_func_decl", "uint", "Z3_ast[]"] => "Z3_ast"],
  [mk_const => ["Z3_context", "Z3_symbol", "Z3_sort"] => "Z3_ast"],
  [mk_fresh_func_decl => ["Z3_context", "Z3_string", "uint", "Z3_sort[]", "Z3_sort"] => "Z3_func_decl"],
  [mk_fresh_const => ["Z3_context", "Z3_string", "Z3_sort"] => "Z3_ast"],
  [mk_rec_func_decl => ["Z3_context", "Z3_symbol", "uint", "Z3_sort[]", "Z3_sort"] => "Z3_func_decl"],
  [add_rec_def => ["Z3_context", "Z3_func_decl", "uint", "Z3_ast[]", "Z3_ast"] => "void"],
  [mk_true => ["Z3_context"] => "Z3_ast"],
  [mk_false => ["Z3_context"] => "Z3_ast"],
  [mk_eq => ["Z3_context", "Z3_ast", "Z3_ast"] => "Z3_ast"],
  [mk_distinct => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_ast"],
  ...
  [mk_and => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_ast"],
  [mk_or => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_ast"],
  [mk_add => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_ast"],
  [mk_mul => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_ast"],
  [mk_sub => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_ast"],
  ...
  [mk_select_n => ["Z3_context", "Z3_ast", "uint", "Z3_ast const*"] => "Z3_ast"],
  [mk_store => ["Z3_context", "Z3_ast", "Z3_ast", "Z3_ast"] => "Z3_ast"],
  [mk_store_n => ["Z3_context", "Z3_ast", "uint", "Z3_ast const*", "Z3_ast"] => "Z3_ast"],
  [mk_const_array => ["Z3_context", "Z3_sort", "Z3_ast"] => "Z3_ast"],
  [mk_map => ["Z3_context", "Z3_func_decl", "uint", "Z3_ast const*"] => "Z3_ast"],
  ...
  [mk_set_union => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_ast"],
  [mk_set_intersect => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_ast"],
  ...
  [mk_uint_int => ["Z3_context", "uint", "Z3_sort"] => "Z3_ast"],
  [mk_int64 => ["Z3_context", "int64_t", "Z3_sort"] => "Z3_ast"],
  [mk_uint_int64 => ["Z3_context", "uint64_t", "Z3_sort"] => "Z3_ast"],
  [mk_bv_numeral => ["Z3_context", "uint", "bool const*"] => "Z3_ast"],
  ...
  [mk_seq_concat => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_ast"],
  ...
  [mk_re_union => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_ast"],
  [mk_re_concat => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_ast"],
  [mk_re_range => ["Z3_context", "Z3_ast", "Z3_ast"] => "Z3_ast"],
  [mk_re_loop => ["Z3_context", "Z3_ast", "uint", "uint"] => "Z3_ast"],
  [mk_re_intersect => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_ast"],
  [mk_re_complement => ["Z3_context", "Z3_ast"] => "Z3_ast"],
  [mk_re_empty => ["Z3_context", "Z3_sort"] => "Z3_ast"],
  [mk_re_full => ["Z3_context", "Z3_sort"] => "Z3_ast"],
  [mk_pattern => ["Z3_context", "uint", "Z3_ast[]"] => "Z3_pattern"],
  [mk_bound => ["Z3_context", "uint", "Z3_sort"] => "Z3_ast"],
  [mk_forall => ["Z3_context", "uint", "uint", "Z3_pattern[]", "uint", "Z3_sort[]", "Z3_symbol[]", "Z3_ast"] => "Z3_ast"],
  [mk_exists => ["Z3_context", "uint", "uint", "Z3_pattern[]", "uint", "Z3_sort[]", "Z3_symbol[]", "Z3_ast"] => "Z3_ast"],
  [mk_quantifier => [" Z3_context", "bool", "uint", "uint", "Z3_pattern[]", "uint", "Z3_sort[]", "Z3_symbol[]", "Z3_ast"] => "Z3_ast"],
  [mk_quantifier_ex => [" Z3_context", "bool", "uint", "Z3_symbol", "Z3_symbol", "uint", "Z3_pattern[]", "uint", "Z3_ast[]", "uint", "Z3_sort[]", "Z3_symbol[]", "Z3_ast"] => "Z3_ast"],
  [mk_forall_const => [" Z3_context", "uint", "uint", "Z3_app[]", "uint", "Z3_pattern[]", "Z3_ast body "] => "Z3_ast"],
  [mk_exists_const => [" Z3_context", "uint", "uint", "Z3_app[]", "uint", "Z3_pattern[]", "Z3_ast body "] => "Z3_ast"],
  [mk_quantifier_const => [" Z3_context", "bool", "uint", "uint", "Z3_app[]", "uint", "Z3_pattern[]", "Z3_ast body "] => "Z3_ast"],
  [mk_quantifier_const_ex => [" Z3_context", "bool", "uint", "Z3_symbol", "Z3_symbol", "uint", "Z3_app[]", "uint", "Z3_pattern[]", "uint", "Z3_ast[]", "Z3_ast body "] => "Z3_ast"],
  [mk_lambda => ["Z3_context", "uint", "Z3_sort[]", "Z3_symbol[]", "Z3_ast"] => "Z3_ast"],
  [mk_lambda_const => ["Z3_context", "uint", "Z3_app[]", "Z3_ast"] => "Z3_ast"],
  ...
  [mk_atmost => ["Z3_context", "uint", "Z3_ast[]", "uint"] => "Z3_ast"],
  [mk_atleast => ["Z3_context", "uint", "Z3_ast[]", "uint"] => "Z3_ast"],
  [mk_pble => ["Z3_context", "uint", "Z3_ast[]", "int[]", "int"] => "Z3_ast"],
  [mk_pbge => ["Z3_context", "uint", "Z3_ast[]", "int[]", "int"] => "Z3_ast"],
  [mk_pbeq => ["Z3_context", "uint", "Z3_ast[]", "int[]", "int"] => "Z3_ast"],
  ...
  [update_term => ["Z3_context", "Z3_ast", "uint", "Z3_ast[]"] => "Z3_ast"],
  [substitute => ["Z3_context", "Z3_ast", "uint", "Z3_ast[]", "Z3_ast[]"] => "Z3_ast"],
  [substitute_vars => ["Z3_context", "Z3_ast", "uint", "Z3_ast[]"] => "Z3_ast"],
  ...
  [model_eval => ["Z3_context", "Z3_model", "Z3_ast", "bool", "Z3_ast *"] => "Z3_bool"],
  [model_get_const_interp => ["Z3_context", "Z3_model", "Z3_func_decl"] => "Z3_ast_opt"],
  [model_has_interp => ["Z3_context", "Z3_model", "Z3_func_decl"] => "bool"],
  [model_get_func_interp => ["Z3_context", "Z3_model", "Z3_func_decl"] => "Z3_func_interp_opt"],
  ...
  [benchmark_to_smtlib_string => ["Z3_context", "Z3_string", "Z3_string", "Z3_string", "Z3_string", "uint", "Z3_ast[]", "Z3_ast"] => "Z3_string"],
  [parse_smtlib2_string => ["Z3_context", "Z3_string", "uint", "Z3_symbol[]", "Z3_sort[]", "uint", "Z3_symbol[]", "Z3_func_decl[]"] => "Z3_ast_vector"],
  [parse_smtlib2_file => ["Z3_context", "Z3_string", "uint", "Z3_symbol[]", "Z3_sort[]", "uint", "Z3_symbol[]", "Z3_func_decl[]"] => "Z3_ast_vector"],
  [eval_smtlib2_string => ["Z3_context", "Z3_string"] => "Z3_string"],
  [get_error_code => ["Z3_context"] => "Z3_error_code"],
  [set_error_handler => ["Z3_context", "Z3_error_handler"] => "void"],
  ...
  [tactic_par_or => ["Z3_context", "uint", "Z3_tactic[]"] => "Z3_tactic"],
  ...
  [solver_check_assumptions => ["Z3_context", "Z3_solver", "uint", "Z3_ast[]"] => "Z3_lbool"],
  [get_implied_equalities => ["Z3_context", "Z3_solver", "uint", "Z3_ast[]", "uint[]"] => "Z3_lbool"],
  ...
  [mk_fpa_numeral_int => ["Z3_context", "signed", "Z3_sort"] => "Z3_ast"],
  [mk_fpa_numeral_int_uint => ["Z3_context", "bool", "signed", "uint", "Z3_sort"] => "Z3_ast"],
  ...
  [mk_fpa_to_fp_uint => ["Z3_context", "Z3_ast", "Z3_ast", "Z3_sort"] => "Z3_ast"],
  ...
  [algebraic_roots => ["Z3_context", "Z3_ast", "uint", "Z3_ast[]"] => "Z3_ast_vector"],
  [algebraic_eval => ["Z3_context", "Z3_ast", "uint", "Z3_ast[]"] => "int"],
  ...
  [optimize_check => ["Z3_context", "Z3_optimize", "uint", "Z3_ast[]"] => "Z3_lbool"],
  ...
  [rcf_mk_roots => ["Z3_context", "uint", "Z3_rcf_num[]", "Z3_rcf_num[]"] => "uint"],
  ...
  [rcf_get_numerator_denominator => ["Z3_context", "Z3_rcf_num", "Z3_rcf_num *", "Z3_rcf_num *"] => "void"],
];
